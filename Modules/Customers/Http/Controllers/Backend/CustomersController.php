...
class CustomersController extends BackendBaseController
{
    ...
    public function index_data_cust(Request $request)
    {
        ...
        if ($login_role_id == 1) {
            $query = User::select(
                ...
                'users.created_at',
                'users.updated_at',
                'customer_statistics.win_count',
                'customer_statistics.lose_count'
            )
    ...
    public function visitor()
    {
        ...
        return view(
            "{$module_path}.{$module_name}.visitor",
            compact(
                'module_title',
                'module_name',
                'module_path',
    ...
    public function visitor_data(Request $request)
    {
        ...
        $flattenedDataCollection = collect($flattenedData);

        return Datatables::of($flattenedDataCollection)
    ...
    public function update_claim(Request $request)
    {
        ...
        return view(
            "{$module_path}.{$module_name}.update_claim",
            compact(
                'module_title',
                'module_name',
                'module_path',
