...
<x-backend.layouts.edit >
    ...
    <div class="row mt-4">
        ...
        {{ html()->modelForm($userprofile, 'PATCH', route('backend.stores.update', $$module_name_singular->id))->class('form-horizontal')->attributes(['enctype'=>"multipart/form-data"])->open() }}
