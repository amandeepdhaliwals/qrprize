...
<html lang="en">
   <head>
      ...
      <!-- Google Fonts -->
        ...
        <!-- Vendor CSS Files -->
        <link href="{{ asset('assets/redtheme/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/redtheme/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
      ...
      <main id="main">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-12 text-center">
                     <div class="logo">
                        <img src="{{ asset('assets/redtheme/img/qr-prize-logo.png') }}">
                     </div>
                  </div>
               </div>
            </div>
        ...
        <section id="forth-section" class="forth-section">
            <div class="container" data-aos="zoom-out">
                <div class="forth-section-body">
                    <h4 class="mb-0" id="dynamic-heading">
                        {{ $primary_images->first()->title }}
                    </h4>
                </div>
            </div>
        </section>
        ...
        <section id="fifth-section" class="fifth-section">
            <div class="container" data-aos="zoom-out">
                <div class="fifth-section-body">
                    <h4 class="mb-0" id="fifth-dynamic-heading">
                      {{$advertisement_detail->other_coupon_prize_heading}}
                    </h4>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="spinner-box">
                            <img 
                                src="{{ asset('assets/redtheme/img/spin-wheel.png') }}" 
                                alt="Spin Wheel" 
                                id="spinning-image" 
                                class="fade-out"
                            >
